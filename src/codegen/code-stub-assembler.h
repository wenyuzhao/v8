...
#undef BINT_COMPARISON_OP
  ...
  // If turbo_allocation_folding is disabled, this will only allocate the first object.
  ...
  // If turbo_allocation_folding is disabled, this will do an extra allocation instead of returning the biased address directly.
  // Special case: Memento object allocations are always folded together with their base objects.
